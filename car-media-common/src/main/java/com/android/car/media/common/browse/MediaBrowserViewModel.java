...
public interface MediaBrowserViewModel {
    ...
    class Factory {
        ...
        /**
         * Returns an initialized {@link WithMutableBrowseId} with the
         ...
         */
        @NonNull
        public static WithMutableBrowseId getInstanceWithMediaBrowser(
        ...
        /**
         * Fetch an initialized {@link WithMutableBrowseId}. It will get its
         ...
         */
        @NonNull
        public static WithMutableBrowseId getInstanceForKey(
