...
public class MediaBrowserViewModelImpl extends AndroidViewModel implements
     ...
     */
    void setConnectedMediaBrowser(@androidx.annotation.Nullable LiveData<MediaBrowserCompat> mediaBrowser) {
    ...
    @UiThread
    @Override
    public void setCurrentBrowseId(@androidx.annotation.Nullable String browseId) {
    ...
    @UiThread
    @Override
    public void search(@androidx.annotation.Nullable String query) {
