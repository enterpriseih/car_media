...
public class AccountImageChangeObserver {
    ...
    private class ContactChangeContentObserver extends ContentObserver {
        ...
        public ContactChangeContentObserver(Context context, Account watchedAccount) {
            ...
            mContext = context;
            mCurrentImageUri = com.android.car.apps.common.AccountImageHelper.getAccountPictureUri(mContext, mWatchedAccount);
        }
        ...
        public void onChange(boolean selfChange) {
            String newUri = com.android.car.apps.common.AccountImageHelper.getAccountPictureUri(mContext, mWatchedAccount);
    ...
    public synchronized void registerChangeUriIfPresent(com.android.car.apps.common.BitmapWorkerOptions options) {
        ...
        if (imageUri != null && com.android.car.apps.common.UriUtils.isAccountImageUri(imageUri)) {
            Uri changeNotifUri = com.android.car.apps.common.UriUtils.getAccountImageChangeNotifyUri(imageUri);
            ...
            String accountName = com.android.car.apps.common.UriUtils.getAccountName(imageUri);
