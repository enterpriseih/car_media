...
public class PagedSnapHelper extends LinearSnapHelper {
     ...
     *
     * @param layoutManager The current {@link LayoutManager} for the attached
     *                      RecyclerView.
     ...
     */
    @Override
    protected RecyclerView.SmoothScroller createScroller(LayoutManager layoutManager) {
    ...
    boolean isAtStart(LayoutManager layoutManager) {
        if (layoutManager == null || layoutManager.getChildCount() == 0) {
            return true;
        }
    ...
    public boolean isAtEnd(LayoutManager layoutManager) {
        if (layoutManager == null || layoutManager.getChildCount() == 0) {
            return true;
        }
